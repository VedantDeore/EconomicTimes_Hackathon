      ...
      <div className="w-full max-w-lg">
        ...
        <div className="p-8 rounded-2xl bg-white border border-gray-200 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" required value={formData.full_name}
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-gray-50 border border-gray-300
                    text-gray-900 text-sm focus:outline-none focus:border-[#00D09C] transition-all"
          ...
          <p className="text-center text-gray-500 mt-5 text-sm">
            ...
            <Link href="/login" className="text-[#00D09C] hover:text-[#00B386] font-medium">Sign In</Link>
          </p>
        </div>
      </div>
    </div>
